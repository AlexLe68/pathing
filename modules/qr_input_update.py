...
def qr_scanner_thread(frame_queue, result_queue, stop_event):
...
def qr_input(device: "int | str") -> "tuple[bool, str | None]":
    ...
    scanner_thread = threading.Thread(target=qr_scanner_thread, args=(frame_queue, result_queue, stop_event))
